# 097-sudoku-classic-b3-93x3-mirror_h-60

Generate **60** sudoku-classic puzzles in **band 3 (Medium)** on a
**9×9** grid with **3×3** boxes and **mirror_h** symmetry.

- Dig no further than **17** clues.
- Band 3 is **scarce** at this shape, so the attempt budget is **24000**.
