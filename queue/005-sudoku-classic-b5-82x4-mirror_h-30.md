# 005-sudoku-classic-b5-82x4-mirror_h-30

Generate **30** sudoku-classic puzzles in **band 5 (Brutal)** on a
**8×8** grid with **2×4** boxes and **mirror_h** symmetry.

- Dig no further than **14** clues.
- Band 5 is **plentiful** at this shape, so the attempt budget is **1800**.
