# 007-sudoku-classic-b2-84x2-mirror_h-30

Generate **30** sudoku-classic puzzles in **band 2 (Easy)** on a
**8×8** grid with **4×2** boxes and **mirror_h** symmetry.

- Dig no further than **14** clues.
- Band 2 is **plentiful** at this shape, so the attempt budget is **1800**.
