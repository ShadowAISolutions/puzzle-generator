# 074-sudoku-classic-b4-93x3-mirror_h-60

Generate **60** sudoku-classic puzzles in **band 4 (Hard)** on a
**9×9** grid with **3×3** boxes and **mirror_h** symmetry.

- Dig no further than **17** clues.
- Band 4 is **plentiful** at this shape, so the attempt budget is **3600**.
